...
* [CHANGE] The default group_by is no labels. (#1287)
* [CHANGE] Set global SMTP hello to "localhost" by default (#1290)
* [CHANGE] Sort dispatched alerts by job+instance (#1234)
